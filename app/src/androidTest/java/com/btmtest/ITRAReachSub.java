...
public class ITRAReachSub extends RAReach                          //~va1aR~
{                                                                  //~va1aI~
	private AG AG=StaticVars.AG;                                   //~va1aI~
    private int[][] dupCtr;                                        //~va1aR~
    private boolean[] btsWin=new boolean[34];      		//for Shanten calc//~va60I~//~va1aI~
	//*************************************************************************//~va1aI~
	private void setUpRonTest()                                    //~va1aR~
    {                                                              //~va1aI~
//        swAllInHand=true;                                        //~va1aR~
//        UARV=AG.aUARonValue;                                     //~va1aR~
//        swListAll=true; //protect for ITUAReachChk               //~va1aR~
//        btsWin=new boolean[PIECE_TYPECTR];  //protect for ITUAReachChk//~va1aR~
    }                                                              //~va1aI~
	//*************************************************************************//~va1aI~
	private boolean chkReachSub()                                  //~va1aI~
    {                                                              //~va1aI~
    	int ctrHand=0;                                             //~va1aI~
        for (int ii=0;ii<3;ii++)                                       //~va1aI~
        	for (int jj=0;jj<9;jj++)                                   //~va1aI~
            	ctrHand+=dupCtr[ii][jj];                           //~va1aR~
        for (int jj=0;jj<7;jj++)                                       //~va1aI~
            ctrHand+=dupCtr[3][jj];                                //~va1aR~
    	int ctrWin=getWinList(dupCtr,ctrHand);                     //~va1aR~
        return ctrWin!=0;                                              //~va1aI~
    }                                                              //~va1aI~
	//*************************************************************************//~9C12I~
...
//        setUpRonTest();                                          //~va1aR~
                                                                   //~va1aI~
	    boolean rc;
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest");        //~va1aR~
//		ctrTileAll=HANDCTR_TAKEN;                                  //~9C12I~
//****1                                                            //~va1aR~
		Arrays.fill(btsWin,false);                                 //~va1aR~
        ...
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-201           1  rc="+rc);//+va1aR~
...
//****2                                                            //~va1aR~
	    ...
	    rc=chkReachSub();                                          //~va1aI~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-202           2  rc="+rc);//+va1aR~
...
//****3                                                            //~va1aR~
	    ...
	    rc=chkReachSub();                                          //~va1aI~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-203           3  rc="+rc);//+va1aR~
...
//****4                                                            //~va1aR~
        ...
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-1 4Anko 4 rc="+rc);//+va1aR~
...
//****5                                                            //~va1aR~
        ...
        dupCtr=new int[][]{   //4 anko     2,3,4,5sou              //~va1aR~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~va1aI~
	    rc=chkReachSub();                                          //~va1aI~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-1-2 4Anko 5 rc="+rc);//+va1aR~
...
//****6                                                            //~va1aR~
	    ...
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-2 7pair 6  rc="+rc);//+va1aR~
...
//****7                                                            //~va1aR~
	    ...
	    rc=chkReachSub();                                          //~va1aI~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-2-2 7pair 7 rc="+rc);//+va1aR~
...
//****8                                                            //~va1aR~
	    ...
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-3 7pair err 8 rc="+rc);//+va1aR~
...
//***9*                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                                        //~9C12R~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-4 4seq  9 rc="+rc);//+va1aR~
...
//***10*                                                           //~va1aR~
        ...
        dupCtr=new int[][]{          //4pin                        //~va1aR~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~va1aI~
	    rc=chkReachSub();                                          //~va1aI~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-4-2 4seq  10 rc="+rc);//+va1aR~
...
//***11*                                                           //~va1aR~
        ...
        dupCtr=new int[][]{          //1,3,4,5,7,8                 //~va1aR~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-5 4seq-3  11 rc="+rc);//+va1aR~
...
//***12                                                            //~va1aR~
	    ...
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-6 13All 13wait r12 c="+rc);//+va1aR~
...
//***13                                                            //~va1aR~
	    ...
	    rc=chkReachSub();                                          //~va1aI~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-6-2 13All  13 rc="+rc);//+va1aR~
...
//***14                                                            //~va1aR~
	    ...
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-7 13All err1  14 rc="+rc);//+va1aR~
...
//***15                                                            //~va1aR~
	    ...
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-8 13All 15 rc="+rc);//+va1aR~
...
//***16                                                            //~va1aR~
	    ...
	    rc=chkReachSub();                                          //~va1aI~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-8-2 13All 16 err2 rc="+rc);//+va1aR~
...
//***17                                                            //~va1aR~
        ...
        dupCtr=new int[][]{          //1pin                        //~va1aR~
    	    ...
    	    { 1,1,1,1,  1,1,1, 0,0} };                             //~va1aR~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-9 13All 17 rc="+rc);//+va1aR~
...
//***18                                                            //~va1aR~
        ...
        dupCtr=new int[][]{        //34567    2.5.8  sou           //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-21 1  18 rc="+rc);//+va1aR~
...
//***19                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                 //2345 pin  2.5        //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-22 1       19       rc="+rc);//+va1aR~
...
//***20                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                   //2345678 pin 2.5.8  //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-23 1      20        rc="+rc);//+va1aR~
...
//***21                                                            //~va1aR~
        ...
        dupCtr=new int[][]{              //67888 gg   1,5.8.       //~va1aR~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-24 1      21        rc="+rc);//+va1aR~
...
//***22                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                     //5666 zou 4.5.7   //~va1aR~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-25 1     22         rc="+rc);//+va1aR~
...
//***23                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                           //4666 sou 4.5//~va1aR~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-26 1      23        rc="+rc);//+va1aR~
...
//***24                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                     //2345666 pin 1.2.4.5.7//~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-27 1        24      rc="+rc);//+va1aR~
...
//***25                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                   //2345777 pin 2.5.6  //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-28 1          25    rc="+rc);//+va1aR~
...
//***26                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                         //2333456 pin   1.2.4.7//~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-29 1          26    rc="+rc);//+va1aR~
...
//***27                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                //3334568 pin 7.8       //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-30 1          27    rc="+rc);//+va1aR~
...
//***28                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                       //3455666 pin 2.4.5.7//~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-31 1          28    rc="+rc);//+va1aR~
...
//***29                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                   //3455777 pin 2.5.6  //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-31 5          29    rc="+rc);//+va1aR~
...
//***30                                                            //~va1aR~
        ...
        dupCtr=new int[][]{            //3445666 pin 2.4.5         //~9C12R~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-31 8          30    rc="+rc);//+va1aR~
...
//***31                                                            //~va1aR~
        ...
        dupCtr=new int[][]{             //3455678 man 2.5.8        //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-32 1          31    rc="+rc);//+va1aR~
...
//***32                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                                        //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-33 1          32    rc="+rc);//+va1aR~
...
//***33                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                 //3334445 sou 3.4.5.6  //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-34 1          33    rc="+rc);//+va1aR~
...
//***34                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                 //3334555 sou 2.3.4.5.6//~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-35 1          34    rc="+rc);//+va1aR~
...
//***35                                                            //~va1aR~
        ...
        dupCtr=new int[][]{               //3335777 sou 4.5.6      //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-36 1          35    rc="+rc);//+va1aR~
...
//***36                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                  //3334455  sou 3.4.5.6//~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-37 1          36    rc="+rc);//+va1aR~
...
//***37                                                            //~va1aR~
        ...
        dupCtr=new int[][]{             //3344455 sou  3.4.5       //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-38 1           37   rc="+rc);//+va1aR~
...
//***38                                                            //~va1aR~
        ...
        dupCtr=new int[][]{           //4555567  man   3.4.6.7     //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-39 1          38    rc="+rc);//+va1aR~
...
//***39                                                            //~va1aR~
        ...
        dupCtr=new int[][]{              //4555566 man    3.4.6.7  //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-40 1          39    rc="+rc);//+va1aR~
...
//***40                                                            //~va1aR~
        ...
        dupCtr=new int[][]{                 //5555667 man    4.6.7 //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-41 1          40    rc="+rc);//+va1aR~
...
//***41                                                            //~va1aR~
        ...
        dupCtr=new int[][]{             //5555677  man 4.6.7       //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-42 1          42    rc="+rc);//+va1aR~
...
//***42                                                            //~va1aR~
        ...
        dupCtr=new int[][]{             //2334455556677  2.5.8.6.7 //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-51 1          42    rc="+rc);//+va1aR~
...
//***43                                                            //~va1aR~
        ...
        dupCtr=new int[][]{             //2334456777789  2.5.8.3.6.9//~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-52 1         43     rc="+rc);//+va1aR~
...
//***44                                                            //~va1aR~
        ...
        dupCtr=new int[][]{             //1223344445556  1.7.5.6   //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-53 1          44    rc="+rc);//+va1aR~
...
//***45                                                            //~va1aR~
        ...
        dupCtr=new int[][]{             //2222345666678  1.4.7.5.8 //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-54 1          45    rc="+rc);//+va1aR~
...
//***46                                                            //~va1aR~
        ...
        dupCtr=new int[][]{             //2223445566778  4.7.3.6.9 //~9C12I~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~9C12I~
	    rc=chkReachSub();                                          //~va1aR~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-55 1          46    rc="+rc);//+va1aR~
...
//***47                                                            //~va1aR~
        ...
        dupCtr=new int[][]{             //1--9 9gate               //~va1aI~
    	    ...
    	    { 0,0,0,0,  0,0,0, 0,0} };                         //7 //~va1aI~
	    rc=chkReachSub();                                          //~va1aI~
        if (Dump.Y) Dump.println("ITRAReachSub.reachTest-56 9gate 9wait  47   rc="+rc);//+va1aR~

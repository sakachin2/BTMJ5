...
//            }                                                    //~va11I~
    ...
    {                                                              //~va11I~
        ...
        if (Dump.Y) Dump.println("UARonDataTree.setResult longRankFinal="+longRankFinal.toStringName()+",longRankOther="+longRankOther.toStringName()+",longRankYakuman="+longRankYakuman.toStringName());//~va11I~//+vakhR~

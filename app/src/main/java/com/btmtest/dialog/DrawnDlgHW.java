...
//      endgameType=EGDR_RESET;  //redo by same gamectr      //~9703R~//~9704R~
    ...
    //*******************************************************      //~vaj7I~
	public static void dismissByCancelDrawnDlgHW()                 //+vaj7R~
    {                                                              //~vaj7I~
        if (Dump.Y) Dump.println("DrawnDlgHW.dismissByCancelDrawnHW");//~vaj7I~
	    DrawnDlgHW dlg=AG.aUAEndGame.dlgConfirmHW;                 //~vaj7I~
    	if (Utils.isShowingDialogFragment(dlg))                    //~vaj7I~
        {                                                          //~vaj7I~
	        if (Dump.Y) Dump.println("DrawnDlgHW.dismissByCancelDrawnHW issue dismiss()");//~vaj7I~
        	dlg.dismiss();                                         //~vaj7I~
        }                                                          //~vaj7I~
    }                                                              //~vaj7I~
    //*******************************************************      //~9608M~

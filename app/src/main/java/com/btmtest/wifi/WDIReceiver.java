//*CID://+DATER~:                             update#=   70;       //~1Ac4R~//~@@@@R~//~9A03R~
//*************************************************************************//~1A65I~
...
//*******************************************************************//~0113M~
    ...
    {                                                              //~0113M~
        ...
        {                                                          //~0113M~
        	status=Pstatus; deviceAddress=Paddr; deviceName=Pname; //~0113R~
	        if (Dump.Y) Dump.println("WDIReceiver.PeerData constructor name="+Pname+",addr="+Paddr+",status="+Pstatus);//~0113R~
        }                                                          //~0113M~
    }                                                              //~0113M~
//*******************************************************************//~0113R~
...
//*******************************************************************//~0113I~
    ...
    {                                                              //~0113I~
        ...
        if (Dump.Y) Dump.println("WDIReceiver.onReceive action="+action+",intent="+intent.toString());//~1Ac4I~//~@@@@I~//~0113R~
        ...
        {                                                          //~0113I~
            ...
            if (Dump.Y) Dump.println("WDIReceiver.onReceive:P2P_STATE_CHANGED_ACTION state="+state);//~0113I~
...
//              activity.resetData();                              //~0113R~
		...
		{                                                          //~0113I~
            if (Dump.Y) Dump.println("WDIReceiver.onReceive P2P_PEERS_CHANGED");//~1A65I~//~@@@@M~//~0113R~
...
//          }                                                      //~0113R~
		...
		{                                                          //~0113I~
            if (Dump.Y) Dump.println("WDIReceiver.onReceive P2P_CONNECTION_CHANGED manager="+Utils.toString(manager));//~1A65I~//~0113I~
            if (manager == null)                                   //~0113R~
			{                                                      //~0113I~
                return;
            }
            NetworkInfo networkInfo =intent.getParcelableExtra(WifiP2pManager.EXTRA_NETWORK_INFO);//~0113R~
	        if (Dump.Y) Dump.println("WDIReceiver.onReceive networkInfo="+Utils.toString(networkInfo));//~0113I~
            if (networkInfo.isConnected())                         //~0113R~
			{                                                      //~0113I~
...
//                AG.aWDA.enableCBWantGroupOwner(true);   //disconnected//~9A03R~//~0113R~
		...
		{                                                          //~0113I~
            if (Dump.Y) Dump.println("WDIReceiver.onReceive P2P_THIS_DEVICE_CHANGED");//~1A65I~//~0113R~
...
//    }                                                              //~0113I~//~0115R~
    ...
    {                                                              //~0115I~
        ...
        if (Dump.Y) Dump.println("WDIReceiver.chkUnpaired devicelist count="+devices.size());//~0115I~
        peers.clear();                                             //~0115I~
...
//    }                                                              //~0113I~//~0115R~
    ...
    {                                                              //~0115I~
        ...
        {                                                          //~0115I~
        	if (Dump.Y) Dump.println("WDIReceiver.closeUnpaired MD["+ii+"]="+m.MD[ii].toString());//~0115I~
...
//*select deleted                                                  //~0113I~
        ...
        {                                                          //~0113I~
	        ...
	        if (Dump.Y) Dump.println("WDIReceiver.listPeers device Old="+devOld.deviceName);//~0113R~
    	    ...
    	    {                                                      //~0113I~
		        ...
		        if (Dump.Y) Dump.println("WDIReceiver.listPeers device New jj="+jj+"="+dev.toString());//~0113R~
...
//*select added                                                    //~0113I~
        ...
        {                                                          //~0113I~
    	    ...
    	    {                                                      //~0113I~
		        ...
		        nameOld=devOld.deviceName;                         //~0113R~
		        if (Dump.Y) Dump.println("WDIReceiver.listPeers device Old="+dev.deviceName);//~0113R~
	    ...
	    if (Dump.Y) Dump.println("WDIReceiver.listPeers Summary ctrDeleted="+peersDeleted.size()+",ctrAdded="+peersAdded.size()+",updated="+peersUpdated.size());//~0115I~
...
//*list deleted                                                    //~0113I~
        ...
        {                                                          //~0113I~
	        ...
	        if (Dump.Y) Dump.println("WDIReceiver.listPeers deviceDeleted="+pd.deviceName);//~0113R~
...
//*list updated                                                    //~0113I~
        ...
        {                                                          //~0113I~
	        ...
	        if (Dump.Y) Dump.println("WDIReceiver.listPeers deviceUpdated="+dev.deviceName);//~0113R~
	        nameNew=dev.deviceName;                                //~0113R~
            if (ii!=0)                                             //~0113I~
            	sb.append(",");                                    //~0113I~
            sb.append(nameNew);                                    //~0113R~
        ...
        {                                                          //~0113I~
        	...
        	if (Dump.Y) Dump.println("WDIReceiver.listPeers ctrChanged="+ctrChanged+",msg="+msg);//~0113I~
    ...
    {                                                              //~0113I~
        if (Dump.Y) Dump.println("WDIReceiver.registerReceiver swBTCD="+swBTCD+",receiver="+Utils.toString(this));//~0113R~
        if (swBTCD)                                                //~0113I~
        	return;                                                //~0113I~
	...
	{                                                              //~0113I~
        if (Dump.Y) Dump.println("WDIReceiver.unregisterReceiver receiver="+Utils.toString(receiver));//~0113I~
		if (receiver==null)                                        //~0113I~
        	return;                                                //~0113I~
	...
	{                                                              //~0113I~
        ...
        if (Dump.Y) Dump.println("WDIReceiver.setIsWifiP2pEnabled enable="+isWifiP2pEnabled);//~0113I~
    }                                                              //~0113I~
    //*****************************************************************//~0113I~
    ...
    {                                                              //~0113M~
        if (Dump.Y) Dump.println("WDIReceiver.requestPeers swChanged="+PswChanged+",manager"+Utils.toString(manager)+",channel="+Utils.toString(channel));//~0113R~

...
//*******************************************************          //~1106I~
public class Shuffle                                               //~1106R~//~1B19R~
{                                                                  //~1106I~
...
//*******************************************                      //~1107I~
private void shuffle()                                    //~1107I~//~1B19R~
{                                                                  //~1B19I~
...
//                    }                                              //~v@@@I~//~v@@5R~//~1B19R~
                	...
                	writeLine("Tiles.shuffle rand="+jj+",t="+tdnew.type+",n="+tdnew.number);//~v@@@I~//~v@@5R~//~1B19I~//+@@@@I~
                }                                                  //~v@@@R~//~v@@5R~//~1B19I~
                else                                               //~v@@@R~//~v@@5R~//~1B19I~
                {                                                  //~v@@@R~//~v@@5R~//~1B19I~
        ...
        writeLine("Tiles.out ="+TileData.toString(out));           //~1B19I~
}                                                                  //~1B19I~
...
//***********************************************                  //~1106I~
    ...
    {                                                              //~1106I~
        ...
        (new Shuffle()).testShuffle();                                 //~1106R~//~1B19R~
		closeOutput();                                             //~1107I~
    }                                                              //~1106I~
}//class                                                           //~1106R~
